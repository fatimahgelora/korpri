                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                  <div className="px-8 py-6 border-b border-gray-200">
                    <div className="flex items-center">
                      <section.icon className="w-6 h-6 text-red-600 mr-3" />
                                ...
                                {(endpoint.path.includes('?') || endpoint.method === 'GET') && (
                                  <div>
                                    ...
                                    <input
                                      ...
                                      className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm font-mono focus:ring-2 focus:ring-red-500 focus:border-red-500"
                                    />
                              ...
                              <div className="flex items-center justify-between mb-3">
                                ...
                                <div className="flex items-center space-x-2">
                                  <span className={`px-2 py-1 rounded text-xs font-medium ${
                                    testResults[endpoint.id].status === 200 || testResults[endpoint.id].status === 201
